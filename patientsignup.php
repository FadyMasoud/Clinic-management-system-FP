...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute()) {
            ...
            $_SESSION['patient_sign_id'] = $patient_id;
            $_SESSION['patient_sign_name'] = $name;
            $_SESSION['patient_sign_email'] = $email;
            $_SESSION['patient_sign_picture'] = $profile_picture_path;
            $_SESSION['patient_sign_gender'] = $gender;
            $_SESSION['patient_sign_age'] = $age;
            $_SESSION['patient_sign_phone'] = $phone;
            $_SESSION['patient_sign_address'] = $address;
            $_SESSION['patient_sign_diseases'] = $diseases;
            $_SESSION['patient_sign_doctor_id'] = $doctor_id;
            $_SESSION['patient_sign_appointment_date'] = $appointment_date;
